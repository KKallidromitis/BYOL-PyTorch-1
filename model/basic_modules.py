...
class EncoderwithProjection(nn.Module):
    ...
    def forward(self, x, masks,mask_ids, binary_mask, num_rois):
        ...
        #breakpoint()
        # SIMCLR CHANGE (SAMPLE MASKS)
        _, mask_ids = sample_masks(binary_mask, n_masks=num_rois)
        masks = torch.stack([masks[b][mask_ids[b]] for b in range(bs)])
